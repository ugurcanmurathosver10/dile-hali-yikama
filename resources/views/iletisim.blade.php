...
@section('title', 'İletişim | ' . config('dilekhaliyikama.firma_adi'))
...
<section class="bg-brand-dark py-16 text-center text-white relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4" data-aos="fade-down">
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24" data-aos="zoom-in">
